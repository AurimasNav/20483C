        ...
        private void studentsList_KeyDown(object sender, KeyEventArgs e)
        {
            switch (e.Key)
            {
                ...
                case Key.Insert:
                    ...
                    if (newStudentForm.ShowDialog().Value)
                    {
                        ...
                        {
                            FirstName = newStudentForm.firstName.Text,
                            LastName = newStudentForm.lastName.Text,
                            DateOfBirth = DateTime.Parse(newStudentForm.dateOfBirth.Text, CultureInfo.InvariantCulture, DateTimeStyles.AssumeLocal)
                        };
