...
namespace GradesPrototype.Services
{
    ...
    class ClassFullException : Exception
    {
        ...
        public ClassFullException() : base()
        {

        }

        public ClassFullException(string exceptionMessage, Exception inner) : base(exceptionMessage, inner)
        {

        }

        public ClassFullException(string exceptionMessage, string className) : base(exceptionMessage)
        {
            _className = className;
        }

        public ClassFullException(string exceptionMessage, string className, Exception inner): base(exceptionMessage, inner)
        {
            _className = className;
        }
